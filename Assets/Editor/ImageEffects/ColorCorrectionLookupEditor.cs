            ...
            if (tex && (target as ColorCorrectionLookup).basedOnTempTex != AssetDatabase.GetAssetPath(tex))
            {
                ...
                else if (GUILayout.Button ("Convert and Apply"))
                {
                    ...
                    if (textureImporter.textureFormat != TextureImporterFormat.AutomaticTruecolor) {
                        doImport = true;
#pragma warning disable CS0618 // “TextureImporterFormat.AutomaticTruecolor”已过时:“Use textureCompression property instead” 
                    }
#pragma warning restore CS0618 // “TextureImporterFormat.AutomaticTruecolor”已过时:“Use textureCompression property instead” 
