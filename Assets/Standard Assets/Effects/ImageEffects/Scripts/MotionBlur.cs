...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class MotionBlur : ImageEffectBase
    {
        ...
        override protected void Start()
        {
            ...
            {
#pragma warning disable CS0618 // “SystemInfo.supportsRenderTextures”已过时:“supportsRenderTextures always returns true, no need to call it” 
                enabled = false;
#pragma warning restore CS0618 // “SystemInfo.supportsRenderTextures”已过时:“supportsRenderTextures always returns true, no need to call it” 
                return;
            }
            base.Start();
        }
